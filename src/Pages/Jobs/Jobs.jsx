...
const Jobs = () => {
    ...
    return (
        <div>
            ...
            <button className="p-2 bg-teal-600 hover:bg-teal-500 text-white rounded-lg mt-6 w-2/3 mx-auto flex items-center justify-center">+ Create New Job</button>

            <h3 className="font-medium text-[14px] mt-16 mb-4">Recent Added Jobs</h3>
